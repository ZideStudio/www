...
export const MEMBERS: Member[] = [
  {
    ...
    messageEn:
      'Hey, I am JulesJuul!<br/>As a passionate developer, I create all kinds of applications in my spare time, without pressure or deadlines.<br/>Just for the pleasure of coding and sharing my projects with everyone!',
    messageFr:
      'Hey, je suis JulesJuul!<br/>Développeur passionné, je crée des applications de tout type pendant mon temps libre, sans pression, sans deadlines.<br/>Juste par plaisir de coder et de partager mes projets à tous!',
