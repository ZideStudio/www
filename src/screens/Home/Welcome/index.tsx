    ...
    <div className="h-screen w-screen relative flex flex-col items-center justify-center antiSelect">
      ...
      <div className="z-10">
        <motion.img
          ...
          alt="ZIDE"
          className="text-white h-64 antiSelect"
        ...
        <motion.p className="kanit-regular text-2xl mt-6 text-center text-[#00579F] drop-shadow-lg shadow-black" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 1, ease: 'easeOut' }}>
